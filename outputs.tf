...
output "ssh_connect_command" {
  description = "The AWS CLI command to connect to the instance using SSH - if you created a public machine"
  value       = "ssh -i chrisfu-support.pem ec2-user@${module.ec2.public_ip}"
}
